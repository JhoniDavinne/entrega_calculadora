 ...
 public static void main(String[] args){
	 ...
	 aux = Integer.parseInt(JOptionPane.showInputDialog(null,"Digite o tipo de operação que deseja realizar:\n(1) Soma\n(2) Subtração\n(3) Multiplicação\n(4) Divisão\n(0) Sair"));
	 	...
	 	if(aux == 1){
			...
			a = Integer.parseInt(JOptionPane.showInputDialog("Digite um número inteiro para multiplicar:"));
			b = Integer.parseInt(JOptionPane.showInputDialog("Digite outro"));
			JOptionPane.showMessageDialog(null,a+" * "+b+" = "+(a*b));
		}else if(aux == 4){
			a = Integer.parseInt(JOptionPane.showInputDialog("Digite um número inteiro para dividir:"));
			b = Integer.parseInt(JOptionPane.showInputDialog("Digite outro"));
			JOptionPane.showMessageDialog(null,a+" / "+b+" = "+(a/b));
		}else if(aux == 0){
